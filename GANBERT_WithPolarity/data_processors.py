...
class QcFineProcessor(DataProcessor):
    ...
    def get_labeled_examples(self, data_dir):
        """See base class."""
        return self._create_examples(os.path.join(data_dir, "labeled_2.tsv"), "train")

    def get_unlabeled_examples(self, data_dir):
        """See base class."""
        return self._create_examples(os.path.join(data_dir, "unlabeled_1.tsv"), "train")

    def get_test_examples(self, data_dir):
        """See base class."""
        return self._create_examples(os.path.join(data_dir, "test_2.tsv"), "test")
    ...
    def get_labels(self):
        ...
        return ["UNK_UNK", "truthful_positive", "truthful_negative", "deceptive_positive", "deceptive_negative"]
