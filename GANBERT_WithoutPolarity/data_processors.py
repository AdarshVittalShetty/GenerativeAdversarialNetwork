...
class QcFineProcessor(DataProcessor):
    ...
    def get_labeled_examples(self, data_dir):
        """See base class."""
        return self._create_examples(os.path.join(data_dir, "labeled_1.tsv"), "train")
    ...
    def get_test_examples(self, data_dir):
        """See base class."""
        return self._create_examples(os.path.join(data_dir, "test_1.tsv"), "test")
    ...
    def get_labels(self):
        ...
        return ["UNK_UNK", "truthful_truthful", "deceptive_deceptive"]
